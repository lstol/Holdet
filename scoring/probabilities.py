...
def _rider_roles(
    ...
    Precedence: probability signal → value bracket → TT additive.
    Probability signal overrides value-bracket specialist assignment to prevent
    duplicates and ensure strong empirical evidence takes priority.
    """
    roles = []
